...
const STRINGS = {
  es: {
    ...
    close: 'Cerrar',
    printCaption: (pinLabel, cutMm, sheetLabel) =>
      `${pinLabel} — corte ${cutMm}mm · Hoja ${sheetLabel} · Imprime al 100% — no escalar`,
  },
  en: {
    ...
    close: 'Close',
    printCaption: (pinLabel, cutMm, sheetLabel) =>
      `${pinLabel} — ${cutMm}mm cut · ${sheetLabel} sheet · Print at 100% — do not scale`,
  },
};
